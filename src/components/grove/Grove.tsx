  ...
  if ($[0] === Symbol.for('react.memo_cache_sentinel')) {
    t0 = (
      <Text>
        ...
        <Text bold={true}>October 8, 2025</Text>. You can accept the updated
        terms today.
      </Text>
    )
    $[0] = t0
    ...
    t5 = (
      <Box flexDirection="column">
        ...
        <Box paddingLeft={1}>
          <Text>
            <Text>· </Text>
            <Text bold={true}>Updates to data retention </Text>
            <Text>
              — To help us improve our AI models and safety protections, we're
              extending data retention to 5 years.
            </Text>
          </Text>
        </Box>
      </Box>
  ...
  if ($[8] === Symbol.for('react.memo_cache_sentinel')) {
    t8 = (
      <>
        ...
        {t5}
        <Text>
          Learn more ({t6}) or read the updated Consumer Terms ({t7}) and
          Privacy Policy (<Link url="https://anthropic.com/legal/privacy" />)
        </Text>
      </>
    )
    $[8] = t8
  ...
  if ($[3] === Symbol.for('react.memo_cache_sentinel')) {
    t3 = (
      <Box flexDirection="column" gap={1}>
        ...
        {t2}
        <Box flexDirection="column">
          <Text bold={true}>How this affects data retention</Text>
          <Text>
  ...
  if ($[6] === Symbol.for('react.memo_cache_sentinel')) {
    t6 = (
      <>
        ...
        {t3}
        <Text>
          Learn more ({t4}) or read the updated Consumer Terms ({t5}) and
          Privacy Policy (<Link url="https://anthropic.com/legal/privacy" />)
        </Text>
      </>
    )
...
export function GroveDialog(t0) {
  ...
  if ($[8] !== groveConfig?.domain_excluded) {
    t4 = groveConfig?.domain_excluded
      ? [
          {
            label:
              'Accept terms \xB7 Help improve Claude: OFF (for emails with your domain)',
  ...
  if ($[18] === Symbol.for('react.memo_cache_sentinel')) {
    t9 = (
      <Box flexDirection="column">
        <Text bold={true}>Please select how you'd like to continue</Text>
  ...
  if ($[24] !== onChange) {
    t12 = value_0 =>
      onChange(value_0 as 'accept_opt_in' | 'accept_opt_out' | 'defer')
    $[24] = onChange
    $[25] = t12
  } else {
    t12 = $[25]
  ...
  if ($[26] !== handleCancel || $[27] !== t11 || $[28] !== t12) {
    t13 = (
      <Box flexDirection="column" gap={1}>
        {t9}
        <Select options={t11} onChange={t12} onCancel={handleCancel} />
      </Box>
    )
    $[26] = handleCancel
    $[27] = t11
